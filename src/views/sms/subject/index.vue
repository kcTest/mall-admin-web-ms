<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="newSubjectTable" :cell-style="{'text-align':'center'}" :header-cell-style="{'text-align':'center'}"
                :data="list"
                style="width: 100%;"
  ...
  methods: {
    ...
    handleUpdateSort() {
      this.$confirm('是否要修改排序?', '提示', {
        ...
        updateHomeSubjectSort(this.sortDialogData.id, {sort: this.sortDialogData.sort}).then(() => {
