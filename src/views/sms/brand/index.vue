<template>
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="品牌名称：">
            <el-input class="input-width" v-model="listQuery.brandName" placeholder="品牌名称"></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button class="btn-add" @click="handleSelectBrand" size="mini" style="margin-left: 20px">选择品牌</el-button>
    </el-card>
    <div class="table-container">
      <el-table :cell-style="{'text-align':'center'}" :header-cell-style="{'text-align':'center'}" ref="homeBrandTable"
  ...
  methods: {
    ...
    handleSelectDialogConfirm: function () {
      ...
      for (let i = 0; i < this.dialogData.multiSelection.length; i++) {
        selectBrands.push({
          brandId: this.dialogData.multiSelection[i].id,
          brandName: this.dialogData.multiSelection[i].name,
        });
      }
    ...
    handleUpdateSort: function () {
      this.$confirm('是否要修改排序', '提示', {
        ...
        updateHomeBrandSort(this.sortDialogData.id, {sort: this.sortDialogData.sort}).then(() => {
          this.$message({message: '修改成功', type: 'success', duration: 1000});
