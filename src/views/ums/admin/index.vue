  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      <div>
        ...
        <span style="margin-left: 4px">筛选搜索</span>
        <el-button
            style="float:right"
            type="primary"
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span style="margin-left: 4px">数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">添加</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="adminTable" :cell-style="{'text-align':'center'}" :header-cell-style="{'text-align':'center'}"
                :data="list"
                style="width: 100%;"
        ...
        <el-table-column label="添加时间" width="160">
          <template v-slot="scope">{{ scope.row.createTime | formatDateTime }}</template>
        </el-table-column>
        <el-table-column label="最后登录" width="160">
          <template v-slot="scope">{{ scope.row.loginTime | formatDateTime }}</template>
        </el-table-column>
