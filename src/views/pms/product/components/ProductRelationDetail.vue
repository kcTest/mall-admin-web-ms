<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productRelationForm" label-width="120px" style="width: 682px" size="small">
      <el-form-item label="关联专题：">
        <el-transfer style="display: inline-block" filterable :filter-method="filterMethod"
                     filter-placeholder="请输入专题名称" v-model="selectSubject" :titles="subjectTitles" :data="subjectList">
        </el-transfer>
      </el-form-item>
      <el-form-item label="关联优选：">
        <el-transfer style="display: inline-block" filterable :filter-method="filterMethod"
                     filter-placeholder="请输入优选名称" v-model="selectPreferenceArea" :titles="preferenceAreaTitles"
...
export default {
  ...
  methods: {
    ...
    getPreferenceAreaList: function () {
      fetchPreferenceAreaList().then(response => {
        ...
        console.log('getPreferenceAreaList', err);
      })
    },
    handlePrev: function () {
      this.$emit('prevStep');
    },
    handleFinishCommit: function () {
