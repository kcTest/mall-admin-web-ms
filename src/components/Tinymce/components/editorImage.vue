<template>
  <div class="upload-container">
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible">
      <el-upload :class="editor-slide-upload" :action="dataObj.host" :data="dataObj" :multiple="true"
                 :file-list="fileList" :show-file-list="true" list-type="picture-card" :on-remove="handleRemove"
  ...
  methods: {
    ...
    handleSubmit: function () {
      ...
      if (!this.checkAllSuccess()) {
        this.$message({message: '请等待所有图片上传成功 或 出现了网络问题，请刷新页面重新上传'});
        return;
      }
